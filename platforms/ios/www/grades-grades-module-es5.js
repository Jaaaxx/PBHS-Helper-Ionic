(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["grades-grades-module"], {
  ...
  function srcAppGradesGradesRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    GradesPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppGradesGradesModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    GradesPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppGradesGradesPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let GradesPage = class GradesPage {
      ...
      doRefresh(event) {
        ...
        const rowChildren = rows.children; // @ts-ignore
        ...
        this.getLogin().then(r => {
          const endpoint = "https://pinnacle-scraper.herokuapp.com/api?un=".concat(r.un, "&pw=").concat(r.pw);
      ...
      ngOnInit() {
        this.getLogin().then(r => document.getElementById('currentUserGR').innerHTML = "Sign Out: <b>".concat(r.un, "</b>"));
        this.presentLoading();
        this.getLogin().then(r => {
          const endpoint = "https://pinnacle-scraper.herokuapp.com/api?un=".concat(r.un, "&pw=").concat(r.pw);
          fetchAsync(endpoint).then(data => {
    ...
    GradesPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-grades',
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"]])], GradesPage);
    /***/
  }
}]);
