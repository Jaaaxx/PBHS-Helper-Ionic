...
/***/ "./src/app/RouterOutletService.ts":
/*!****************************************!*\
  !*** ./src/app/RouterOutletService.ts ***!
  \****************************************/
/*! exports provided: RouterOutletService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RouterOutletService", function() { return RouterOutletService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let RouterOutletService = class RouterOutletService {
    constructor() {
    }
...
RouterOutletService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
const routes = [
    ...
    { path: 'login', loadChildren: () => __webpack_require__.e(/*! import() | login-login-module */ "login-login-module").then(__webpack_require__.bind(null, /*! ./login/login.module */ "./src/app/login/login.module.ts")).then(m => m.LoginPageModule) },
    { path: 'grades', loadChildren: () => __webpack_require__.e(/*! import() | grades-grades-module */ "grades-grades-module").then(__webpack_require__.bind(null, /*! ./grades/grades.module */ "./src/app/grades/grades.module.ts")).then(m => m.GradesPageModule) },
    {
        path: 'assignments',
        loadChildren: () => __webpack_require__.e(/*! import() | assignments-assignments-module */ "assignments-assignments-module").then(__webpack_require__.bind(null, /*! ./assignments/assignments.module */ "./src/app/assignments/assignments.module.ts")).then(m => m.AssignmentsPageModule)
    },
    { path: 'calendar', loadChildren: () => __webpack_require__.e(/*! import() | calendar-calendar-module */ "calendar-calendar-module").then(__webpack_require__.bind(null, /*! ./calendar/calendar.module */ "./src/app/calendar/calendar.module.ts")).then(m => m.CalendarPageModule) }
];
...
/* harmony import */ var _RouterOutletService__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./RouterOutletService */ "./src/app/RouterOutletService.ts");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, router, statusBar, routerOutletService) {
        this.platform = platform;
        this.splashScreen = splashScreen;
        this.router = router;
        this.statusBar = statusBar;
        this.routerOutletService = routerOutletService;
        this.initializeApp();
    }
    getLogin() {
...
AppComponent.ctorParameters = () => [
    ...
    { type: _RouterOutletService__WEBPACK_IMPORTED_MODULE_7__["RouterOutletService"] }
];
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
        ...
        _RouterOutletService__WEBPACK_IMPORTED_MODULE_7__["RouterOutletService"]])
], AppComponent);
...
module.exports = __webpack_require__(/*! /Users/jacksonhutton/Desktop/PBHS-Helper-Ionic/src/main.ts */"./src/main.ts");
